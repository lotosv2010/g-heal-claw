...
import {
  ...
  type TopPageRow,
  type TopRequestRow,
} from "../api-monitor/api-monitor.service.js";
import type {
  ApiDimensionRowDto,
  ApiDimensionsDto,
  ApiOverviewDto,
 ...
 *  - trend 透传 ApiMonitorService.aggregateTrend
 *  - topSlow 透传 ApiMonitorService.aggregateSlowApis
 */
@Injectable()
export class DashboardApiService {
  public constructor(private readonly apiMonitor: ApiMonitorService) {}
