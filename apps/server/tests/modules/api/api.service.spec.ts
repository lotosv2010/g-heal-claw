...
import { ApiService } from "../../../src/modules/api/api.service.js";
import type { DatabaseService } from "../../../src/shared/database/database.service.js";

/**
 * ApiService 单测（ADR-0020 §4.2 / TM.1.A.3 / ADR-0025 命名统一）
 *
...
describe("ApiService / aggregateStatusBuckets", () => {
...
describe("ApiService / aggregateTrend", () => {
...
describe("ApiService / aggregateSlowApis", () => {
...
describe("ApiService / aggregateTopRequests", () => {
...
describe("ApiService / aggregateTopPages", () => {
...
describe("ApiService / aggregateErrorStatus", () => {
...
describe("ApiService / aggregateDimension", () => {
