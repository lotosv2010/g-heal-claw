...
/**
 * ResourcesService 单测（ADR-0022 §3 / TM.1.B.3 / ADR-0025 命名统一）
 *
...
describe("ResourcesService / aggregateCategoryBuckets", () => {
...
describe("ResourcesService / aggregateTrend", () => {
...
describe("ResourcesService / aggregateSlowResources", () => {
...
describe("ResourcesService / aggregateFailingHosts", () => {
