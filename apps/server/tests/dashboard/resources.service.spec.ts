...
import { DashboardResourcesService } from "../../src/dashboard/resources.service.js";
import type {
  CategoryBucketRow,
  FailingHostRow,
  ...
  SlowResourceRow,
} from "../../src/resource-monitor/resource-monitor.service.js";
 ...
 *
 * 装配层是纯拼装逻辑（无 DB 访问），通过注入 ResourceMonitorService stub 覆盖：
...
function createStubService(stub: StubResource): ResourceMonitorService {
  ...
  } as unknown as ResourceMonitorService;
}
